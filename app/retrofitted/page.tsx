  ...
  return (
    <section>
      ...
      <div className='h-screen relative overflow-hidden flex flex-col items-center'>
        ...
        >
          <h1
            className={`text-[clamp(1.75rem,8vh,3rem)] md:text-[clamp(1.75rem,8vh,8rem)] font-bold text-[rgb(231,214,141)] mix-blend-difference leading-none [text-box-trim:trim-end] [text-box-edge:cap_alphabetic] ${shrikhand.className}`}
          >
            retrofitted
          </h1>
        </div>
