    ...
    <section className='bg-yellow-300'>
      ...
      <div className='bg-yellow-300 px-4 md:px-8 pt-16 pb-16'>
        <div className='flex flex-col gap-8'>
          {/* Brief Section */}
          <div>
            <h2 className='text-xl font-extrabold tracking-tight  border-b-2 border-black pb-2 mb-4'>brief</h2>
          ...
          <div>
            <h2 className='text-xl font-extrabold tracking-tight  border-b-2 border-black pb-2 mb-4'>specifications</h2>
          ...
          {/* Idea Section */}
          <div>
            <h2 className='text-xl font-extrabold tracking-tight  border-b-2 border-black pb-2 mb-4'>idea</h2>
            <div className='grid grid-cols-1 md:grid-cols-5 gap-y-2 text-base'>
              <div className='hidden md:block'></div>
              <div className='hidden md:block'></div>
              <div className='hidden md:block'></div>
          ...
          {/* credits Section */}
          <div>
            <h2 className='text-xl font-extrabold tracking-tight  border-b-2 border-black pb-2 mb-4'>credits</h2>
            <div className='grid grid-cols-2 md:grid-cols-5 gap-y-2 text-base'>
              <div className='hidden md:block'></div>
      ...
      <div className='bg-yellow-300 px-4 md:px-8 pt-12 pb-16'>
        <div>
          <h2 className='text-xl font-extrabold tracking-tight  border-b-2 border-black pb-2 mb-6'>process</h2>
